...
class DashboardService:
        ...
        try:
            ...
            dashboard = {
                ...
                "progress": self._calculate_goal_progress(
                    water_summary, food_summary, gym_summary, user_goals
                ),
            }
    ...
    def get_weekly_dashboard(
        self, user_id: int, start_date: Optional[datetime] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            while current_date < end_date:
                daily_water = self.water_service.get_daily_summary(
            ...
            weekly_trend = self.health_calculator.calculate_weekly_trend(
                daily_health_scores
            )
    ...
    def _calculate_goal_progress(
        ...
        water_progress = (
            ...
            if user_goals["daily_water_ml"] > 0
            else 0
        )
        ...
        return {
            ...
            "calories": {
                ...
                "achieved": 90
                <= (calorie_actual / calorie_goal * 100 if calorie_goal > 0 else 0)
                <= 110,
            },
            "exercise": {
    ...
    def _generate_weekly_achievements(
        ...
        if (
            gym_summary.get("total_workouts", 0) >= user_goals["weekly_exercise"]
            and water_summary.get("total_ml", 0) >= weekly_water_goal * 0.9
        ):
            achievements.append(
                {
